 ...
 *
 * ⚠️ НЕ участвует (оба вида, по состоянию на 23.09.2026): нет материалов/
 ...
 * (стыковка со стенами, см. wallJoin.ts) есть у ОБОИХ видов: у винтовой —
 * по единому 24-угольнику внешнего контура; у маршевой (с 23.09.2026) —
 * по каждому segment (флайт/площадка) отдельно, своими 4 гранями.
 */
