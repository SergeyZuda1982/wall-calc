...
// Форматирование метров для блока результата текущей перегородки
        ...
        <div style={{ padding: 24, fontFamily: 'sans-serif', maxWidth: 900 }}>
            ...
            {activeTab === 'wall' && <>
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-end', marginBottom: 16 }}>
                    ...
                    {overlapWarning && (
                        <div style={{
                            flex: 2, fontSize: 12, color: '#c05000',
                    ...
                    <>
                        <div style={{
                            ...
                            <button onClick={() => shiftGrid(-Number(shiftInput))}
                                style={{
                                    padding: '4px 12px', fontSize: 14, cursor: 'pointer',
                                    background: '#fff', border: '1px solid #aaa', borderRadius: 4
                                }}>
                                ← влево
                            </button>
            ...
            {hasAnything && (() => {
                ...
                return (
                    <div style={{ marginTop: 28, borderRadius: 8, overflow: 'hidden', border: '1px solid #ccd' }}>
                        {/* Заголовок */}
                        <div style={{
                            padding: '10px 14px', background: '#e8edf8',
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                {usedMaterials.map(k => {
                                    ...
                                    // Суммируем штуки из каждой позиции отдельно (не ceil от суммы!)
