...
describe('calcPolygonP113Frame — контур с дыркой (шахта)', () => {
  ...
  it('дырка разбивает как минимум один ряд несущего профиля на бОльшее число вставок', () => {
    ...
    // основного профиля (1000/2000/3000 при stepC=1000, W=4000 — 30.07.2026:
    // последний ряд больше не сдвигается к стене, если сдвиг создал бы
    // разрыв больше шага, поэтому теперь ровно 3000, не ~3750), чтобы
