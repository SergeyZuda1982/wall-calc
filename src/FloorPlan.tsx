                  ...
                  {mode === 'select' && rooms.map(room => {
                    ...
                    return (
                      <Group key={'marker-' + room.id}
                        ...
                        onTap={e => { if (touchGestureRef.current) return; e.cancelBubble = true; setInspectorRoomId(room.id); setInspectorId(null); setInspectorRoundColumnId(null); setInspectorRectColumnId(null); setInspectorFreeformId(null); setSelected(null) }}>
                  ...
                  {mode === 'select' && roundColumns.map(rc => {
                    ...
                    return (
                      <Group key={'marker-' + rc.id}
                        ...
                        onTap={e => { if (touchGestureRef.current) return; e.cancelBubble = true; setInspectorRoundColumnId(rc.id); setInspectorId(null); setInspectorRoomId(null); setInspectorRectColumnId(null); setInspectorFreeformId(null); setSelected(null) }}>
                  ...
                  {mode === 'select' && rectColumns.map(rc => {
                    ...
                    return (
                      <Group key={'marker-' + rc.id}
                        ...
                        onTap={e => { if (touchGestureRef.current) return; e.cancelBubble = true; setInspectorRectColumnId(rc.id); setInspectorId(null); setInspectorRoomId(null); setInspectorRoundColumnId(null); setInspectorFreeformId(null); setSelected(null) }}>
                  ...
                  {mode === 'select' && freeformStructures.map(fs => {
                    ...
                    return (
                      <Group key={'marker-' + fs.id}
                        ...
                        onTap={e => { if (touchGestureRef.current) return; e.cancelBubble = true; setInspectorFreeformId(fs.id); setInspectorId(null); setInspectorRoomId(null); setInspectorRoundColumnId(null); setInspectorRectColumnId(null); setSelected(null) }}>
                        <Circle x={cx} y={cy} radius={r} fill="#fff" stroke="#78909c" strokeWidth={1.5 / stageScale} />
